...
public static class Dc20StandardVariables
{
    ...
    public static Variable MultiFaceted = new()
    {
        ...
        Cost = 1,
        Description =
            "The Weapon gains a second Weapon Style. When you make an Attack with the Weapon, you must choose which Weapon Style to use. The chosen Weapon Style determines the Attack’s damage type.",
        Properties = new() { VariableProperty.Melee },
    ...
    public static Variable Concealable = new()
    {
        ...
        Cost = 1,
        Description =
            "You have ADV on the first Attack you make against a creature using a concealed Weapon. You can only gain this benefit against each creature once per Combat.",
        Properties = new() { VariableProperty.Melee, VariableProperty.Ranged }
    };
    ...
    public static Variable TwoHanded = new()
    {
        ...
        CountsTowardsMaximumProperties = false,
        DefaultVariableForProperties = new() { VariableProperty.Melee, VariableProperty.Ranged }
    };
    ...
    public static Variable Unwieldy = new()
    {
        ...
        CountsTowardsMaximumProperties = false,
        DefaultVariableForProperties = { VariableProperty.Melee, VariableProperty.Ranged }
    };
    ...
    public static Variable LongRanged = new()
    {
        ...
        Properties = new() { VariableProperty.Ranged },
    ...
    public static Variable Reload = new()
    {
        ...
        DamageIncrease = 1,
        Description =
            "The Weapon’s damage increases by 1, but you must spend 1 AP and use a free hand to reload the Weapon.",
        Properties = new() { VariableProperty.Ranged }
    };
