...
public static class Dc20StandardSkills
{
    public static readonly Skill Awareness = new()
    {
        ...
        AttributeUsed = CharacterAttribute.Prime.Name
    };
    public static readonly Skill Athletics = new()
    {
        ...
        AttributeUsed = CharacterAttribute.Might.Name,
    ...
    public static readonly Skill Acrobatics = new()
    {
        ...
        AttributeUsed = CharacterAttribute.Agility.Name,
        UseForMartialCheck = true
    };
    ...
    public static readonly Skill AnimalHandling = new()
    {
        ...
        AttributeUsed = CharacterAttribute.Charisma.Name
    };
    ...
    public static readonly Skill Investigation = new()
    {
        ...
        AttributeUsed = CharacterAttribute.Intelligence.Name
    };
    ...
    public static List<string> AttributeOptions => CharacterAttribute.GetAttributes().Select(a => a.Name).ToList();
